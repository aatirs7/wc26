...
const CHANGELOG: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    ...
    desc: 'Call the exact scoreline of upcoming matches for bonus points. Opens 24h before kickoff, locks at kickoff, and adds straight into your standings total.',
  },
  {
    icon: MessageCircle,
    title: 'Trash talk',
    desc: 'A family chat feed to talk your talk all tournament. Find it on the home screen.',
  },
];
