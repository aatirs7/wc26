...
export default function DesktopNav() {
  ...
  return (
    <nav className="glass fixed inset-x-0 top-0 z-40 hidden border-b border-edge shadow-lg shadow-black/20 lg:block">
      <div className="mx-auto flex h-16 max-w-6xl items-center gap-8 pl-8 pr-20">
        <Link
          href="/home"
          className="group flex shrink-0 items-center gap-2.5 transition-opacity hover:opacity-90"
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-accent/10 ring-1 ring-accent/30 transition-colors group-hover:bg-accent/20">
            <Trophy className="h-5 w-5 text-accent" strokeWidth={2.2} />
          </span>
          <span className="flex flex-col leading-none">
            <span className="font-display text-xl tracking-wide">Siddiqui League</span>
            <span className="text-[0.6rem] font-bold uppercase tracking-[0.25em] text-muted-2">
              World Cup 2026
            </span>
          </span>
        </Link>
