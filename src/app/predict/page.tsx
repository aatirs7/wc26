...
export default async function PredictPage() {
  ...
  // Only tease matches whose window opens soon: kickoff within the next 48h.
  const UPCOMING_WINDOW_MS = 48 * 60 * 60 * 1000;
  const upcomingShow = upcoming.filter((m) => m.kickoffUtc.getTime() <= now + UPCOMING_WINDOW_MS);
